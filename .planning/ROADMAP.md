# Roadmap: Restaurant Management System (backend)

## Milestones

- ✅ **v1.0 MVP** — Phases 01–18 (shipped 2026-07-15) → full detail: [milestones/v1.0-ROADMAP.md](milestones/v1.0-ROADMAP.md)

## Phases

<details>
<summary>✅ v1.0 MVP (Phases 01–18, 50 plans) — SHIPPED 2026-07-15</summary>
...
- [x] Phase 18: order & order-item cancellation with compensation — CANCELLED terminal status, inventory release, auto Payment refund, kitchen void — 2026-07-15
...
| --------- | ------ | ----- | ------ | ------- |
| v1.0 MVP  | 01–18  | 50/50 | ✅ Complete | 2026-07-15 |
