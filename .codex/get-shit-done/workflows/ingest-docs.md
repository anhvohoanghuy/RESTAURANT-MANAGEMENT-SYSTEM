...
```bash
INIT=$(node "C:/Users/chinh/IdeaProjects/feat1/.codex/get-shit-done/bin/gsd-tools.cjs" init ingest-docs)
...
```bash
node "C:/Users/chinh/IdeaProjects/feat1/.codex/get-shit-done/bin/gsd-tools.cjs" commit \
