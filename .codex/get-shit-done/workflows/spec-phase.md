...
```bash
INIT=$(node "C:/Users/chinh/IdeaProjects/feat1/.codex/get-shit-done/bin/gsd-tools.cjs" init phase-op "${PHASE}")
...
Use the SPEC.md template from @C:/Users/chinh/IdeaProjects/feat1/.codex/get-shit-done/templates/spec.md.
