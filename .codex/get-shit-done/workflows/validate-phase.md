...
```
Agent(
  prompt="Read C:/Users/chinh/IdeaProjects/feat1/.codex/agents/gsd-nyquist-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `C:/Users/chinh/IdeaProjects/feat1/.codex/get-shit-done/templates/VALIDATION.md`
